<template>
  <div class="">
    <div class="container prod-header">
      <b-jumbotron>
        <template v-slot:header>机械行业解决方案</template>
      ...
      <article>
        ...
        <ol>
          <li>
            ...
            外协加工进度失控及不良率高，影响订单工序计划，易造成交期延期。 4.
            加工过程返工及报废率高，生产过程因图纸和操作规范问题导致不良较多 5.
            图纸、SOP手工管理、人工变更管理难度大、效率低、易出错。 6.
            制造过程品控与质量追溯不健全 7.
            设备综合利用率低，产能效率低，制造成本高。 8.
            生产设备品牌型号多，部分设备无接口协议，无设备运行状态监控。 9.
            行业需求 10.
            基础数据量大、订单多、数据变更频繁，需要与ERP数据共享、业务协同联控。
            11.
            物料形态多样、余料多不易识别利用，需要系统管理、收发物料条码自动识别
            12. 订单作业计划排程、产能负荷实时动态统计，合理排产提升设备OEE。
            13.
            作业计划与生产派工协同，直接派工到员工工位，生产执行实时监控及调度调整。
            14. 订单生产进度（含外协工序）实时掌控，支持销售跟单查生产进度。 15.
            生产加工执行动态数据实时采集，精准掌握生产状态。 16.
            检验工序流程控制，检验数据在线采集，降低人为失误导致的错误。 17.
            不良原因实时统计预警，不良处理系统流程管理，对不良责任人工、返工工时等记录，便于事后分析改善。
            18. 关注异常发生与处理，及时处理异常，减少停工等待。 19.
            设备状态实时监控，加工效率实时自动统计。 20.
            图纸文件在线查看，无纸化应用 21. 解决方案 1.
